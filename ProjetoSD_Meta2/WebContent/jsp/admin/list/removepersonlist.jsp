...
<body>
	...
	<s:div class = "content">
		<p/>
		<s:form action="removepersonlist" method="post">
			Person ID:<br>
			<s:textfield name="listBean.ID" /><br>
			<br>List Name:<br>
			<s:textfield name="listBean.name" /><br>
			<br>List Election:<br>
			<s:textfield name="listBean.election" /><br><br>
			<s:submit type="button">Remove</s:submit>
		</s:form>
		<br>
