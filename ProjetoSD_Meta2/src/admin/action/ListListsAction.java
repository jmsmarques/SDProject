...
public class ListListsAction extends ActionSupport implements SessionAware{
	...
	public String execute() {
		...
		if(permission != null && permission && (boolean)session.get("admin")) {
			...
			ArrayList<String> auxList = (ArrayList<String>) aux.getListsList();
			if(auxList != null) {
				...
				auxList.add("No Lists Available");
			}
			aux.setLists(lists);
			return SUCCESS;
		}
